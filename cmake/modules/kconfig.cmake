...
if(CONFIG_NCS_IS_VARIANT_IMAGE)
  ...
  if(SB_CONFIG_PARTITION_MANAGER)
    ...
    # message(WARNING "FLASH_LOAD_OFFSET in kconfig.cmake: ${CONFIG_FLASH_LOAD_OFFSET}")
      dt_chosen(fw_to_relocate_property PROPERTY "fw-to-relocate")
      if(NOT "${fw_to_relocate_property}" STREQUAL "")
        dt_partition_addr(fw_to_relocate_offset PATH "${fw_to_relocate_property}" REQUIRED)
      endif()
      ...
      if(NOT "${fw_to_relocate_property}" STREQUAL "")
        if("${line}" MATCHES "^CONFIG_BUILD_OUTPUT_ADJUST_LMA=.*$")
          string(REGEX REPLACE "CONFIG_BUILD_OUTPUT_ADJUST_LMA=(.*)" "CONFIG_BUILD_OUTPUT_ADJUST_LMA= 0x0e000000 + ${fw_to_relocate_offset}- 0x23000000" line ${line})
        endif()
      endif()
